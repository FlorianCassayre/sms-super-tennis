sub_get_joy_p2:
	...
	and a			; a7 ;02a6
	jr z,+		; 28 0f ;02a7
	in a,(I_JOYPAD_1)		; db dc ;02a9
	ld c,a			; 4f ;02ab
	in a,(I_JOYPAD_2)		; db dd ;02ac
	rl c		; cb 11 ;02ae
	rla			; 17 ;02b0
	rl c		; cb 11 ;02b1
	rla			; 17 ;02b3
...
+:
	...
	out (O_DE),a		; d3 de ;02ba
	in a,(I_JOYPAD_1)		; db dc ;02bc
	ld c,a			; 4f ;02be
	in a,(I_JOYPAD_2)		; db dd ;02bf
	rl c		; cb 11 ;02c1
	rla			; 17 ;02c3
	rl c		; cb 11 ;02c4
	rla			; 17 ;02c6
	...
	out (O_DE),a		; d3 de ;02ca
	in a,(I_JOYPAD_1)		; db dc ;02cc
