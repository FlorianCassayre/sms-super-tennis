sub_2e98h_2d_scale_clamp:
	ld a,(ix + entity_t.x_pos + 1)		; dd 7e 0d ;2e98
	bit 0,(ix + entity_t.side_state)		; dd cb 01 46 ;2e9b
...
+:
	...
	ld (ix + entity_t.x_div_pos),c		; dd 71 2f ;2eb1
	ld a,(ix + entity_t.y_pos + 1)		; dd 7e 0b ;2eb4
	bit 0,(ix + entity_t.side_state)		; dd cb 01 46 ;2eb7
...
+:
	...
	ld (ix + entity_t.y_div_pos),c		; dd 71 2e ;2ecc
	ret			; c9 ;2ecf
