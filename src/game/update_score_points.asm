sub_update_score_points:
	call _sub_315eh		; cd 5e 31 ;2fea
	ld a,(0c481h)		; 3a 81 c4 ;2fed
	cp 000h		; fe 00 ;2ff0
	jp nz,_special_score_state		; c2 d5 30 ;2ff2
	ld a,(score.point.bottom)		; 3a 88 c4 ;2ff5
	cp 004h		; fe 04 ;2ff8
	jp c,_check_top_score		; da 0f 30 ;2ffa
	jp nz,_bottom_wins		; c2 2a 30 ;2ffd
	ld hl,score.point.top		; 21 89 c4 ;3000
	sub (hl)			; 96 ;3003
	jp z,_deuce		; ca 2f 30 ;3004
	ld a,(score.point.top)		; 3a 89 c4 ;3007
	cp 003h		; fe 03 ;300a
	jp c,_bottom_wins		; da 2a 30 ;300c
_check_top_score:
	ld a,(score.point.top)		; 3a 89 c4 ;300f
	cp 004h		; fe 04 ;3012
	jp c,l3037h		; da 37 30 ;3014
	jp nz,_bottom_wins_a		; c2 25 30 ;3017
	ld a,(score.point.bottom)		; 3a 88 c4 ;301a
	cp 003h		; fe 03 ;301d
	jp c,_bottom_wins_a		; da 25 30 ;301f
	jp l3037h		; c3 37 30 ;3022
_bottom_wins_a:
	ld a,010h		; 3e 10 ;3025
	jp _set_winner		; c3 77 31 ;3027
_bottom_wins:
	ld a,001h		; 3e 01 ;302a
	jp _set_winner		; c3 77 31 ;302c
_deuce:
...
_draw_bottom_score_digit:
	push bc			; c5 ;303f
	ld a,(hl)			; 7e ;3040
	cp 000h		; fe 00 ;3041
	jr nz,_bottom_score_digit_1		; 20 03 ;3043
	ld hl,0caech		; 21 ec ca ;3045
_bottom_score_digit_1:
	cp 001h		; fe 01 ;3048
	jr nz,_bottom_score_digit_2		; 20 03 ;304a
	ld hl,0caf0h		; 21 f0 ca ;304c
_bottom_score_digit_2:
	cp 002h		; fe 02 ;304f
	jr nz,_bottom_score_digit_3		; 20 03 ;3051
	ld hl,0caf4h		; 21 f4 ca ;3053
_bottom_score_digit_3:
	cp 003h		; fe 03 ;3056
	jr nz,_bottom_score_digit_4		; 20 03 ;3058
	ld hl,0caf8h		; 21 f8 ca ;305a
_bottom_score_digit_4:
	cp 004h		; fe 04 ;305d
	jr nz,_draw_top_score_digit		; 20 20 ;305f
...
_draw_top_score_digit:
	...
	djnz _draw_bottom_score_digit		; 10 ac ;3091
	ld a,(hl)			; 7e ;3093
	inc hl			; 23 ;3094
	ld b,(hl)			; 46 ;3095
	cp 003h		; fe 03 ;3096
	jp nz,_finish_score_update		; c2 b6 30 ;3098
	sub b			; 90 ;309b
	jp nz,_finish_score_update		; c2 b6 30 ;309c
	ld a,(0c48bh)		; 3a 8b c4 ;309f
	cp 000h		; fe 00 ;30a2
	jr nz,_finish_score_update		; 20 10 ;30a4
	ld a,001h		; 3e 01 ;30a6
	call sub_wait_a_frames		; cd e6 35 ;30a8
	call _sub_313ch		; cd 3c 31 ;30ab
	ld a,050h		; 3e 50 ;30ae
	call sub_wait_a_frames		; cd e6 35 ;30b0
	call _sub_315eh		; cd 5e 31 ;30b3
_finish_score_update:
	xor a			; af ;30b6
	ld (0c4a6h),a		; 32 a6 c4 ;30b7
	ld (0c49dh),a		; 32 9d c4 ;30ba
	call sub_3566h		; cd 66 35 ;30bd
	xor a			; af ;30c0
	ld (SCORE_ANNOUNCEMENT),a		; 32 a5 c4 ;30c1
	...
	ret			; c9 ;30d4
_special_score_state:
	ld hl,score.point.bottom		; 21 88 c4 ;30d5
	ld a,(hl)			; 7e ;30d8
	cp 007h		; fe 07 ;30d9
	jp c,_check_top_special_score		; da ed 30 ;30db
	inc hl			; 23 ;30de
	sub (hl)			; 96 ;30df
	jp c,_check_top_special_score		; da ed 30 ;30e0
	cp 002h		; fe 02 ;30e3
	jp c,_check_top_special_score		; da ed 30 ;30e5
	ld a,001h		; 3e 01 ;30e8
	jp _set_winner		; c3 77 31 ;30ea
_check_top_special_score:
	ld hl,score.point.top		; 21 89 c4 ;30ed
	ld a,(hl)			; 7e ;30f0
	cp 007h		; fe 07 ;30f1
	jp c,_draw_special_score		; da 05 31 ;30f3
	dec hl			; 2b ;30f6
	sub (hl)			; 96 ;30f7
	jp c,_draw_special_score		; da 05 31 ;30f8
	cp 002h		; fe 02 ;30fb
	jp c,_draw_special_score		; da 05 31 ;30fd
	ld a,010h		; 3e 10 ;3100
	jp _set_winner		; c3 77 31 ;3102
_draw_special_score:
	ld a,(score.point.bottom)		; 3a 88 c4 ;3105
	call sub_div10		; cd 82 31 ;3108
	ld a,d			; 7a ;310b
	cp 000h		; fe 00 ;310c
	jr z,_draw_bottom_tens_digit		; 28 07 ;310e
	ld hl,039f8h		; 21 f8 39 ;3110
	ld b,002h		; 06 02 ;3113
	jr _draw_bottom_score		; 18 05 ;3115
_draw_bottom_tens_digit:
...
_set_winner:
	...
	jp _finish_score_update		; c3 b6 30 ;317f
