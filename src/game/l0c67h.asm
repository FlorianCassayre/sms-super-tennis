...
l0cd1h:
	...
	ld (0c089h),a		;0cd8
	xor a			;0cdb
	ld (entities.player.1.bottom.type),a		;0cdc
	ld (entities.player.1.top.type),a		;0cdf
	ld (entities.player.2.bottom.type),a		;0ce2
	ld (entities.player.2.top.type),a		;0ce5
	ld (0c302h),a		;0ce8
	ld (0c302h),a		;0ceb
	ld a,004h		;0cee
	ld (0c007h),a		;0cf0
