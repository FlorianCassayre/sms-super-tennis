sub_game_player_update_animation:
	ld a,(ix + entity_t.animation_flags_or_frame)		; dd 7e 23 ;2a69
	and a			; a7 ;2a6c
	ret z			; c8 ;2a6d
...
+:
	...
	ld a,e			; 7b ;2ab3
	sub d			; 92 ;2ab4
	ld (ix + entity_t.state_flags),a		; dd 77 19 ;2ab5
	inc hl			; 23 ;2ab8
	ld a,(hl)			; 7e ;2ab9
	ld (ix + entity_t.time_before_serve),a		; dd 77 1a ;2aba
	inc hl			; 23 ;2abd
	ld a,(hl)			; 7e ;2abe
	...
	inc hl			; 23 ;2ac7
	ld (ix + entity_t.maybe_sprite_id),l		; dd 75 2b ;2ac8
...
++:
	...
	ret			; c9 ;2ade
+++:
	bit 7,(ix + entity_t.state_flags)		; dd cb 19 7e ;2adf
	jr z,+		; 28 0a ;2ae3
	ld a,(ix + entity_t.time_before_serve)		; dd 7e 1a ;2ae5
	sub 001h		; d6 01 ;2ae8
	jr c,++		; 38 06 ;2aea
	ld (ix + entity_t.time_before_serve),a		; dd 77 1a ;2aec
+:
	dec (ix + entity_t.state_flags)		; dd 35 19 ;2aef
++:
	dec (ix+008h)		; dd 35 08 ;2af2
	ret nz			; c0 ;2af5
	dec (ix+009h)		; dd 35 09 ;2af6
	jr nz,+		; 20 05 ;2af9
	ld (ix + entity_t.animation_flags_or_frame),000h		; dd 36 23 00 ;2afb
	ret			; c9 ;2aff
+:
	ld l,(ix + entity_t.maybe_sprite_id)		; dd 6e 2b ;2b00
	ld h,(ix+02ch)		; dd 66 2c ;2b03
	inc hl			; 23 ;2b06
	inc hl			; 23 ;2b07
	ld (ix + entity_t.maybe_sprite_id),l		; dd 75 2b ;2b08
...
++:
	...
	ld a,(ix + entity_t.state_flags)		; dd 7e 19 ;2b27
	sub d			; 92 ;2b2a
	ld (ix + entity_t.state_flags),a		; dd 77 19 ;2b2b
	ret			; c9 ;2b2e
