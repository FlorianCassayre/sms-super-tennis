...
+:
	...
	and 1
	jr nz,++
	ld hl,BOUND_X_MIN_NEAR_RIGHT
	jr ++
+:
	ld hl,BOUND_X_MIN_FAR_LEFT
	ld a,(state.match_state_flag)
	and 1
	jr z,++
	ld hl,BOUND_X_MIN_FAR_RIGHT
	jr ++
l2704h:
	ld a,(ix + entity_t.id)
	and 1
	jr z,++
	ld hl,BOUND_X_MIN_FAR_STD
++:
...
+:
	...
	and 1
	jr z,++
	ld hl,BOUND_X_MAX_NEAR_LEFT
	jr ++
+:
	ld hl,BOUND_X_MAX_FAR_RIGHT
	ld a,(state.match_state_flag)
	and 1
	jr nz,++
	ld hl,BOUND_X_MAX_FAR_LEFT
	jr ++
l2760h:
	ld a,(ix + entity_t.id)
	and 1
	jr z,++
	ld hl,BOUND_X_MAX_FAR_STD
++:
...
+:
	...
	sub h
	jr c,l27dbh
	ld hl,BOUND_Y_MAX_NEAR
	ld a,(ix + entity_t.id)
	and 1
	jr z,+
	ld hl,BOUND_Y_MAX_FAR
+:
	ld d,(ix + entity_t.y_pos + 1)
	ld a,(ix + entity_t.y_pos)
	sub l
