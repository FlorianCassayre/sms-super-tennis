sub_ball_bounce:
	...
	ld (VEL_Y),hl		; 22 06 c5 ;15ae
	ld a,(BALL_STATE)		; 3a 17 c5 ;15b1
	cp STATE_FROZEN		; fe 02 ;15b4
	ret nc			; d0 ;15b6
	ld de,(VEL_Z)		; ed 5b 0e c5 ;15b7
	bit 7,d		; cb 7a ;15bb
	jr z,+		; 28 07 ;15bd
	xor a			; af ;15bf
...
+:
	...
	ex de,hl			; eb ;15db
+:
	ld (VEL_Z),de		; ed 53 0e c5 ;15dc
	ld de,(VEL_X)		; ed 5b 0c c5 ;15e0
	bit 7,d		; cb 7a ;15e4
	jr z,+		; 28 07 ;15e6
	xor a			; af ;15e8
