sub_apply_player_movement:
	...
	bit 0,(ix + entity.side_state)		; dd cb 01 46 ;27f9
...
sub_lookup_player_velocity:
	...
	add a,a			; 87 ;282a
	ld e,a			; 5f ;282b
	ld a,(ix + entity.allowed_dirs)		; dd 7e 12 ;282c
	and $0F		; e6 0f ;282f
	cp $0B		; fe 0b ;2831
...
l283fh:
	...
	push ix		; dd e5 ;2841
	pop hl			; e1 ;2843
	ld de,entity.x_vel		; 11 0e 00 ;2844
	add hl,de			; 19 ;2847
	ex de,hl			; eb ;2848
	pop hl			; e1 ;2849
	ld bc,$0004		; 01 04 00 ;284a
	ldir		; ed b0 ;284d
	ld e,(ix + entity.y_pos)		; dd 5e 0c ;284f
	ld d,(ix + entity.y_pos + 1)		; dd 56 0d ;2852
	ld l,(ix + entity.y_vel)		; dd 6e 10 ;2855
	ld h,(ix + entity.y_vel + 1)		; dd 66 11 ;2858
...
l2867h:
	add hl,de			; 19 ;2867
	ld (ix + entity.y_pos),l		; dd 75 0c ;2868
	ld (ix + entity.y_pos + 1),h		; dd 74 0d ;286b
	ld e,(ix + entity.cache_y_min)		; dd 5e 3c ;286e
	ld d,(ix + entity.cache_y_min + 1)		; dd 56 3d ;2871
	ld c,l			; 4d ;2874
	ld b,h			; 44 ;2875
	xor a			; af ;2876
	sbc hl,de		; ed 52 ;2877
	jr c,l2888h		; 38 0d ;2879
	ld e,(ix + entity.cache_y_max)		; dd 5e 3e ;287b
	ld d,(ix + entity.cache_y_max + 1)		; dd 56 3f ;287e
	ld l,c			; 69 ;2881
	ld h,b			; 60 ;2882
	xor a			; af ;2883
...
l2888h:
	ld (ix + entity.y_pos),e		; dd 73 0c ;2888
	ld (ix + entity.y_pos + 1),d		; dd 72 0d ;288b
l288eh:
	ld e,(ix + entity.x_pos)		; dd 5e 0a ;288e
	ld d,(ix + entity.x_pos + 1)		; dd 56 0b ;2891
	ld l,(ix + entity.x_vel)		; dd 6e 0e ;2894
	ld h,(ix + entity.x_vel + 1)		; dd 66 0f ;2897
...
l28a6h:
	add hl,de			; 19 ;28a6
	ld (ix + entity.x_pos),l		; dd 75 0a ;28a7
	ld (ix + entity.x_pos + 1),h		; dd 74 0b ;28aa
	ld (ix + entity.x_pos_cache),h		; dd 74 14 ;28ad
	ret			; c9 ;28b0
