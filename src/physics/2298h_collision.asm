sub_2298h_collision:
	ld a,(ball.foul)		; 3a 18 c5 ;2298
	and a			; a7 ;229b
	ld a,000h		; 3e 00 ;229c
	ret nz			; c0 ;229e
	push hl			; e5 ;229f
	exx			; d9 ;22a0
	ld e,(ix + entity_t.y_div_pos)		; dd 5e 2e ;22a1
	ld d,000h		; 16 00 ;22a4
	ld hl,l2290h		; 21 90 22 ;22a6
	add hl,de			; 19 ;22a9
	ld a,(hl)			; 7e ;22aa
	pop hl			; e1 ;22ab
	ld e,(ix + entity_t.x_pos)		; dd 5e 0c ;22ac
	ld d,(ix + entity_t.x_pos + 1)		; dd 56 0d ;22af
	push hl			; e5 ;22b2
	xor a			; af ;22b3
...
+:
	...
	pop hl			; e1 ;22eb
	add hl,de			; 19 ;22ec
	ld (ix + entity_t.x_pos),l		; dd 75 0c ;22ed
	ld (ix + entity_t.x_pos + 1),h		; dd 74 0d ;22f0
++:
...
l22f5h:
	...
	exx			; d9 ;22f6
	pop bc			; c1 ;22f7
	ld l,(ix + entity_t.y_pos)		; dd 6e 0a ;22f8
	ld h,(ix + entity_t.y_pos + 1)		; dd 66 0b ;22fb
	ex de,hl			; eb ;22fe
	xor a			; af ;22ff
